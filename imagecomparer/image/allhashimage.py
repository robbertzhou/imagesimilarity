...
if __name__ == '__main__':
    img1 = cv2.imread(r'g:\testdata\gsimages\1.jpg')
    img2 = cv2.imread(r'g:\testdata\gsimages\test1.jpg')
    time1 = time.time()
    hash1 = aHash(img1)
    hash2 = aHash(img2)
    ...
    time1 = time.time()
    HASH1 = pHash(r'g:\testdata\gsimages\1.jpg')
    HASH2 = pHash(r'g:\testdata\gsimages\test1.jpg')
